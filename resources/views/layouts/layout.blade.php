...
<html>
    ...
    <body data-url="{{ Config::get('app.url') }}" data-section="{{ $frontClass }}">
      ...
      <script>
                        ...
                        <form class="footer__newsletter || newsletter__form" method="post" action="{{ Config::get('app.url') }}addNewsletter">
                            ...
                            <div class="footer__newsletter__form" action="">
                               ...
                               <i class="spinner">
                                ...
                                <button id="sus" class="footer__newsletter__button || newsletter__btn" type="submit">Enviar</button>
        ...
        <script src="https://www.google.com/recaptcha/api.js?render=6LecNq8aAAAAAMc0418UJ41yF6aAdXQy6CnzCDWd" async defer></script>
