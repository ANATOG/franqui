<div class="modal-content">
    ...
    <p>{{ trans('custom.are_you_sure', ['itemDelete' => $item->user_name]) }}</p>
</div>
<div class="modal-footer">
    ...
    {{ Form::open(array('url' => Config::get('app.url').Config::get('app.admin_directory').'/admin/delete/'.$item->id, 'name' => 'delete-form', 'id' => 'delete-form', 'method' => 'delete')) }}
    {{ Form::close() }}
</div>