...
@section('content')
    <div>
        <div class="row">
            {{ Form::open(array('url' => Config::get('app.url').Config::get('app.admin_directory').'/answers/create/'.$survey_id, 'name' => 'login-form', 'id' => 'login-form', 'enctype' => 'multipart/form-data')) }}
                ...
                <div class="row">
                    <div class="input-field col s12">
                        {{ Form::text('answer',old('question'), array('id' => 'question')) }}
                        <label for="question" data-error="wrong" data-success="right">Respuesta</label>
                    </div>
