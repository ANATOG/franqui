...
@section('content')
    <div>
        <div class="row">
            {{ Form::open(array('url' => Config::get('app.url').Config::get('app.admin_directory').'/sponsors/create', 'name' => 'login-form', 'id' => 'login-form', 'enctype' => 'multipart/form-data')) }}
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        {{ Form::text('link', old('link'), array('id' => 'link')) }}
