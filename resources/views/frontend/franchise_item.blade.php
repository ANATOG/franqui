...
@section('metadata')
    <title>Franquiciar - Franquicias en Argentina, Franquicias Rentables - {{ $franchise[0]->meta_title }}</title>
    ...
    <meta property="og:image"              content="{{ Config::get('app.url') }}public/uploads/{{ $franchiseImages['image_top'] }}" />
    ...
    <meta name="twitter:image" content="{{ Config::get('app.url') }}public/uploads/{{ $franchiseImages['image_top'] }}" />
@endsection
...
@section('content')
    ...
    <section class="section__franchise-item">
        ...
        <div class="franchise-item__img-top">
            <i style="background-image: url('{{ Config::get('app.url') }}public/uploads/{{ $franchiseImages['image_top'] }}')"></i>
        </div>
                    ...
                    <article class="info__top">
                        <div class="info__top__wrapper info__top__wrapper--left">
                            <div class="info__top__category">
                                <i style="background-image: url('{{ Config::get('app.url') }}public/uploads/{{ $franchise[0]->getSubjectImage() }}')"></i>
                                <span>{{ $franchise[0]->getSubjectName() }}</span>
                            </div>
                            <i class="info__top__img"
                                style="background-image: url('{{ Config::get('app.url') }}public/uploads/{{ $franchiseImages['logo'] }}')"></i>
                        </div>
            ...
            <div class="franchise-item__data">
                <div class="center-wrapper">
                    ...
                    <section class="data__wrapper data__wrapper--operative">
                        ...
                        <div class="data__img">
                            <i style="background-image: url('{{ Config::get('app.url') }}public/uploads/{{ $franchiseImages['right_one'] }}')"></i>
                        </div>
                    ...
                    <section class="data__wrapper data__wrapper--economic">
                        ...
                        <div class="data__img">
                            <div class="data__img__item">
                                <i style="background-image: url('{{ Config::get('app.url') }}public/uploads/{{ $franchiseImages['left_one'] }}')"></i>
                            </div>
                            <div class="data__img__item">
                                <i style="background-image: url('{{ Config::get('app.url') }}public/uploads/{{ $franchiseImages['left_two'] }}')"></i>
                            </div>
                            <div class="data__img__item">
                                <i style="background-image: url('{{ Config::get('app.url') }}public/uploads/{{ $franchiseImages['left_three'] }}')"></i>
                            </div>
                        </div>
                        ...
                        <div class="suggested__wrapper">
                            @foreach($suggested as $suggest)
                                <a class="suggested__item" href="{{ Config::get('app.url') }}franquicia/{{ $suggest[0]->slug }}">
                                    <i class="suggested__img" style="background-image: url('{{ Config::get('app.url') }}public/uploads/{{ $suggest[0]['image'] }}')"></i>
