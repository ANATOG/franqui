                ...
                <div class="results__top__info">
                    ...
                    <a href="#" class="results__order || custom-select">
                        ...
                        <select class="custom-select__select" name="orden">
                            ...
                            <option value="" disabled>Ordenar por: <h1>{{$pais}}</h1></option>
            ...
            <div class="center-wrapper">
                ...
                <figure class="results__banner banner__responsive">
                    ...
                    @unless(empty($frontBanners['banner_bottom_search']))
                        ...
                        <a href="{{ $frontBanners['banner_bottom_search_url'] }}" target="_blank"><img class="banner__responsive__desktop" src="{{ Config::get('app.url') }}public/uploads/{{ $frontBanners['banner_bottom_search'] }}"/></a>

                    @endunless

                    @unless(empty($frontBanners['banner_bottom_search_mobile']))

                        <a href="{{ $frontBanners['banner_bottom_search_url'] }}" target="_blank"><img class="banner__responsive__mobile" src="{{ Config::get('app.url') }}public/uploads/{{ $frontBanners['banner_bottom_search_mobile'] }}"/></a>
