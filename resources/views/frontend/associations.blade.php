		...
		<ul class="associations__list">
			<li class="associations__item">
				<a href="http://www.portalfiaf.com/quem-somos/" target="_blank">
					<figure class="associations__img">
						<img src="{{ Config::get('app.url') }}public/image/associations/img-fiaf.png">
					</figure>
			...
			<li class="associations__item">
				<a href="http://www.aamf.com.ar/" target="_blank">
					<figure class="associations__img"> 
						<img src="{{ Config::get('app.url') }}public/image/associations/img-amf.png">
					</figure>
		...
		<ul class="associations__list">
			...
			<li class="associations__item">
				<a href="http://www.cfcor.com.ar/" target="_blank">
					<figure class="associations__img"> 
						<img src="{{ Config::get('app.url') }}public/image/associations/img-cfc.png">
					</figure>
			...
			<li class="associations__item">
				<a href="http://caufran.org/" target="_blank">
					<figure class="associations__img"> 
						<img src="{{ Config::get('app.url') }}public/image/associations/img-camarauruguaya.png">
					</figure>
			...
			<li class="associations__item">
				<a href="http://www.franquiciadores.com/" target="_blank">
					<figure class="associations__img">
						<img src="{{ Config::get('app.url') }}public/image/associations/img-aef.png">
					</figure>
			...
			<li class="associations__item">
				<a href="http://franquiciasdemexico.org.mx" target="_blank">
					<figure class="associations__img">
						<img src="{{ Config::get('app.url') }}public/image/associations/img-asociaionmexicana.png">
					</figure>
			...
			<li class="associations__item">
				<a href="http://www.guatefranquicias.org/" target="_blank">
					<figure class="associations__img">
						<img src="{{ Config::get('app.url') }}public/image/associations/img-agf.png">
					</figure>
			...
			<li class="associations__item">
				<a href="http://www.abf.com.br" target="_blank">
					<figure class="associations__img">
						<img src="{{ Config::get('app.url') }}public/image/associations/img-abf.png">
					</figure>
			...
			<li class="associations__item">
				<a href="http://www.cpfranquicias.com/" target="_blank">
					<figure class="associations__img">
						<img src="{{ Config::get('app.url') }}public/image/associations/img-camaraperuana.png">
					</figure>
			...
			<li class="associations__item">
				<a href="http://profranquicias.com" target="_blank">
					<figure class="associations__img">
						<img src="{{ Config::get('app.url') }}public/image/associations/img-profranquicias.png">
					</figure>
			...
			<li class="associations__item">
				<a href="http://www.colfranquicias.com/" target="_blank">
					<figure class="associations__img">
						<img src="{{ Config::get('app.url') }}public/image/associations/img-colfranquicias.png">
					</figure>
			...
			<li class="associations__item">
				<a href="http://www.franquiciascostarricenses.cr/" target="_blank">
					<figure class="associations__img">
						<img src="{{ Config::get('app.url') }}public/image/associations/img-cenaf.png">
					</figure>
			...
			<li class="associations__item">
				<a href="http://www.associacaofranchising.pt/" target="_blank">
					<figure class="associations__img"> 
						<img src="{{ Config::get('app.url') }}public/image/associations/img-apf.png">
					</figure>
			...
			<li class="associations__item">
				<a href="http://www.cafran.org/" target="_blank">
					<figure class="associations__img"> 
						<img src="{{ Config::get('app.url') }}public/image/associations/img-cafran.png">
					</figure>
		...
		<div class="associations__banner">
			<figure class="banner__responsive">
				@unless(empty($frontBanners['banner_bottom_franchising']))
					<a href="{{ $frontBanners['banner_bottom_franchising_url'] }}" target="_blank"><img class="banner__responsive__desktop" src="{{ Config::get('app.url') }}public/uploads/{{ $frontBanners['banner_bottom_franchising'] }}"></a>
				@endunless
				@unless(empty($frontBanners['banner_bottom_franchising_mobile']))
					<a href="{{ $frontBanners['banner_bottom_franchising_url'] }}" target="_blank"><img class="banner__responsive__mobile" src="{{ Config::get('app.url') }}public/uploads/{{ $frontBanners['banner_bottom_franchising_mobile'] }}"></a>
				@endunless
			</figure>
		</div>
