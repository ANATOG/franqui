...
@section('metadata')
    ...
    <title>Franquiciar - Franquicias en Argentina, Franquicias Rentables - {{ $news[0]->title }}</title>
    ...
    <meta property="og:image"              content="{{ Config::get('app.url') }}public/uploads/{{ $news[0]->image }}" />
    ...
    <meta name="twitter:image" content="{{ Config::get('app.url') }}public/uploads/{{ $news[0]->image }}" />
        ...
        <div class="center-wrapper">
                ...
                <section class="news__wrapper__left">
                    ...
                    @else
                        ...
                        <figure class="news-item__img">
                            ...
                            <img src="{{ Config::get('app.url') }}public/uploads/{{ $news[0]->image }}"/>
                            ...
                            <section class="last-news__item">
                                ...
                                <a class="last-new__item__wrapper" href="{{ Config::get('app.url') }}actualidad/{{ $mNew->slug }}">
                                    ...
                                    <i class="last-news__img"
                                        ...
                                        style="background-image: url('{{ Config::get('app.url') }}public/uploads/{{ $mNew->image }}')"></i>
            ...
            <figure class="bottom__banner banner__responsive">
                ...
                @unless(empty($frontBanners['banner_bottom_news']))
                    ...
                    <a href="{{ $frontBanners['banner_bottom_news_url'] }}" target="_blank"><img class="banner__responsive__desktop" src="{{ Config::get('app.url') }}public/uploads/{{ $frontBanners['banner_bottom_news'] }}"></a>

                @endunless

                @unless(empty($frontBanners['banner_bottom_news_mobile']))

                    <a href="{{ $frontBanners['banner_bottom_news_url'] }}" target="_blank"><img class="banner__responsive__mobile" src="{{ Config::get('app.url') }}public/uploads/{{ $frontBanners['banner_bottom_news_mobile'] }}"></a>
