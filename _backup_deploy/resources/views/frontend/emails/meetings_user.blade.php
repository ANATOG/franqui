    ...
    <div style="background-image:url({{ Config::get('app.url') }}uploads/mails/heading-bg.jpg); background-repeat:no-repeat; background-color:#131927; padding: 0 50px;">
        ...
        <div class="container" style="display: table;margin: 0 auto;width: 100%;max-width: 480px;">
            <div style="background-color:#FFFFFF; padding: 70px 30px 95px;margin-bottom: -35px;position: relative;">
                <p style="font-family: Arial, sans-serif;font-size: 16px;color: #515151;display: inline-block;margin-top: 0;line-height: 1.4;">Solicitaste una reunión a la franquicia {{$franchise[0]->name}} a través de la Multiplataforma franquiciar.com.ar.<br/>Esta es la información que le llegará directamente a la franquicia para que pueda contactarte:</p>
                ...
                <p style="font-family: Arial, sans-serif;font-size: 16px;color: #515151;display: inline-block;margin-top: 0;line-height: 1.4;">
                    <b>Tipo de Reunión</b>: {{ $option_text }}<br>
                    <b>Dias</b>: {{ $days }}<br>
                    <b>Rango Horario</b>: {{ $hours }}<br>
                    <b>Skype</b>: {{ $skype }}<br>
                    <b>Mensaje</b>: {{ $message_user }}
                </p>

                <p style="font-family: Arial, sans-serif;font-size: 16px;color: #515151;display: inline-block;margin-top: 0;line-height: 1.4;"">Para confirmar la reunión, se contactarán con vos directamente de la Franquicia.<br/>Cualquier inquietud podés escribirnos a <a href="mailto:franquiciar@franquiciar.com.ar">franquiciar@franquiciar.com.ar</a>.</p>
