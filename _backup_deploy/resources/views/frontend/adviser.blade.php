			...
			<div class="center-wrapper">
				...
				<figure class="member__img banner__responsive">
					@unless(empty($frontBanners['banner_middle_adviser']))
						<a href="{{ $frontBanners['banner_middle_adviser_url'] }}" target="_blank"><img class="banner__responsive__desktop" src="{{ Config::get('app.url') }}uploads/{{ $frontBanners['banner_middle_adviser'] }}"></a>
					@endunless
					@unless(empty($frontBanners['banner_middle_adviser_mobile']))
						<a href="{{ $frontBanners['banner_middle_adviser_url'] }}" target="_blank"><img class="banner__responsive__mobile" src="{{ Config::get('app.url') }}uploads/{{ $frontBanners['banner_middle_adviser_mobile'] }}"></a>
					@endunless
				</figure>
			</div>
		</div>
					...
					@foreach($consultants as $consultant)
						<li class="consultants__item">
							<a href="{{ $consultant['url'] }}" target="_blank">
								<img class="consultants__img" src="{{ Config::get('app.url') }}uploads/{{ $consultant['image'] }}" alt="{{ $consultant['title'] }}">
							</a>
						</li>
					@endforeach
				</ul>
			...
			<div class="center-wrapper">
				<figure class="banner__responsive">
					@unless(empty($frontBanners['banner_bottom_adviser']))
						<a href="{{ $frontBanners['banner_bottom_adviser_url'] }}" target="_blank"><img class="banner__responsive__desktop" src="{{ Config::get('app.url') }}uploads/{{ $frontBanners['banner_bottom_adviser'] }}"></a>
					@endunless
					@unless(empty($frontBanners['banner_bottom_adviser_mobile']))
						<a href="{{ $frontBanners['banner_bottom_adviser_url'] }}" target="_blank"><img class="banner__responsive__mobile" src="{{ Config::get('app.url') }}uploads/{{ $frontBanners['banner_bottom_adviser_mobile'] }}"></a>
					@endunless
				</figure>
			</div>
		</div>
