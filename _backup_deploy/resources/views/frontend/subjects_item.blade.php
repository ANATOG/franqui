            ...
            <div class="center-wrapper">
                                ...
                                <div class="item__wrapper">
                                    ...
                                    <div class="item__bottom">
                                        ...
                                        <div class="item__bottom__wrapper">
                                            ...
                                            <h1 class="item__title">{{ str_limit($franchise->name , '100') }}</h1>
                ...
                <figure class="results__banner banner__responsive">
                    ...
                    @unless(empty($frontBanners['banner_bottom_thematics']))
                        ...
                        <a href="{{ $frontBanners['banner_bottom_thematics_url'] }}" target="_blank"><img class="banner__responsive__desktop" src="{{ Config::get('app.url') }}uploads/{{ $frontBanners['banner_bottom_thematics'] }}"/></a>

                    @endunless

                    @unless(empty($frontBanners['banner_bottom_thematics_mobile']))

                        <a href="{{ $frontBanners['banner_bottom_thematics_url'] }}" target="_blank"><img class="banner__responsive__mobile" src="{{ Config::get('app.url') }}uploads/{{ $frontBanners['banner_bottom_thematics_mobile'] }}"/></a>
