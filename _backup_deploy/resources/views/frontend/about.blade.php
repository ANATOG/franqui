			...
			<div class="center-wrapper">
	            ...
	            <figure class="about__banner banner__responsive">
					...
					@unless(empty($frontBanners['banner_bottom_about']))
						<a href="{{ $frontBanners['banner_bottom_about_url'] }}" target="_blank"><img class="banner__responsive__desktop" src="{{ Config::get('app.url') }}uploads/{{ $frontBanners['banner_bottom_about'] }}"></a>
					@endunless
					@unless(empty($frontBanners['banner_bottom_about_mobile']))
						<a href="{{ $frontBanners['banner_bottom_about_url'] }}" target="_blank"><img class="banner__responsive__mobile" src="{{ Config::get('app.url') }}uploads/{{ $frontBanners['banner_bottom_about_mobile'] }}"></a>
					@endunless
	            </figure>
			</div>
