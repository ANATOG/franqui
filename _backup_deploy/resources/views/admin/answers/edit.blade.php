...
@section('content')
    <div>
        <div class="row">
            {{ Form::open(array('url' => Config::get('app.url').Config::get('app.admin_directory').'/answers/edit/'.$survey_id.'/'.$item->id, 'name' => 'login-form', 'id' => 'login-form', 'method' => 'put', 'enctype' => 'multipart/form-data')) }}
                ...
                <div class="row">
                    <div class="input-field col s12">
                        {{ Form::text('answer',(isset($item->answer))?$item->answer:old('answer'), array('id' => 'answer')) }}
                        <label for="answer" data-error="wrong" data-success="right">Respuesta</label>
                    </div>
