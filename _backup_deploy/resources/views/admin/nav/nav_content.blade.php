<ul id="nav-mobile" class="side-nav fixed" style="transform: translateX(0%);">
    <li class="logo"><a id="logo-container" href="{{Config::get('app.url').Config::get('app.admin_directory')}}" class="brand-logo"><img class="responsive-logo-img" src="{{ Config::get('app.url') }}admin/img/logo.png" alt=""/></a></li>
