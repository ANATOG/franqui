...
@section('content')
    <div>
        <div class="row">
            {{ Form::open(array('url' => Config::get('app.url').Config::get('app.admin_directory').'/franchises-assets/edit_video/'.$franchise_id, 'name' => 'login-form', 'id' => 'login-form', 'method' => 'put', 'enctype' => 'multipart/form-data')) }}
                ...
                <div class="row">
                    <div class="input-field col s12">
                        ...
                        <label for="video" data-error="wrong" data-success="right">Subir Video (colocar link de Youtube)</label>
                    </div>
                </div>
