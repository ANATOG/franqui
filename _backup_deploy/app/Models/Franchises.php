...
class Franchises extends Model
{
     ...
     * @return
     */
    public function scopeListAllFranchisesFront($query, $order = null, $subject = null, $search = null, $price = null)
    {
        $query->where('visible', true);
        if ($search != null) {
     ...
     * @return
     */
    public function scopeListSearchFront($query, $order = null, $subject = null, $search = null, $price = null)
    {
        $query->where('visible', true);
        if ($search != null) {
