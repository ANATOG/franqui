...
class FranchisesController extends BaseAdminController
{
    ...
    public function create()
    {
        ...
        $users = User::where('visible', true)->where('role_id', 3)->pluck('user_name', 'id')->toArray();
        // Add select option to the subjects array
