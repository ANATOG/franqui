    ...
    var a = function() {
        ...
        return r(t, [{
            ...
            value: function(t, e) {
                ...
                this._spinner && s.to(this._spinner, .5, { opacity: 1 }), o.ajax({ method: n, data: o(this._form).serialize(), dataType: "json", context: this._form, url: config.url + r, success: function(n) { i._spinner && s.to(i._spinner, .5, { opacity: 0 }), n.data.status === !1 ? t(n.data.message) : e(n.data.message) }, error: function(t) { i._spinner && s.to(i._spinner, .5, { opacity: 0 }), i._wrapperBlock && (i._wrapperBlock.style.visibility = "hidden"), alert("Hubo un error al enviar la información") } })
            }
        }]), t
    }();
    t.exports = a
...
}, function(t, e) { "use strict"; "remove" in Element.prototype || (Element.prototype.remove = function() { this.parentNode && this.parentNode.removeChild(this) }) }, function(t, e) {
    "use strict";
    ! function() {
